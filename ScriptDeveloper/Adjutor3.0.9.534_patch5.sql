...
SET VERSAOSISTEMA.SCRIPTADJUTOR = '3.0.9.534 patch 5',
       VERSAOSISTEMA.DATA   = '30.07.2019',
	    VERSAO = '3.0.9.534'
...
CREATE OR ALTER VIEW PRD0000_VIEW (PRD_CODIGO, PRD_REFER, PRD_DESCRI, PRD_UND, DESCRICAO, EMP_CODIGO)
AS
