CREATE INDEX KARDEX_ALMOX_SALDO_IDX2
ON KARDEX_ALMOX_SALDO (PRD_CODIGO);

commit work;
--------------------------------------------------------------------------------

ALTER TABLE PED0000
    ADD PED_EXP_UF VARCHAR(2),
    ADD PED_EXP_LOCAL_EXP VARCHAR(60),
    ADD PED_EXP_LOCAL_RECINTO VARCHAR(60);
...
Update VERSAOSISTEMA SET
       VERSAOSISTEMA.SCRIPTADJUTOR = '3.0.0.418' ,
       VERSAOSISTEMA.DATA   = '30.03.2015'
