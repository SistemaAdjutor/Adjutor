ALTER TABLE PRMT0001
    ADD PMT_VALOR_APROX_TRIB VARCHAR(1) DEFAULT 'C';

COMMENT ON COLUMN PRMT0001.PMT_VALOR_APROX_TRIB IS
'C = SOMENTE CONSUMIDOR
T = TODOS';

commit work;
--------------------------------------------------------------------------------

UPDATE PRMT0001 SET PMT_VALOR_APROX_TRIB = 'C' WHERE PMT_VALOR_APROX_TRIB IS NULL;
...
Update VERSAOSISTEMA SET
       VERSAOSISTEMA.SCRIPTADJUTOR = '3.0.0.417' ,
       VERSAOSISTEMA.DATA   = '17.03.2015'
