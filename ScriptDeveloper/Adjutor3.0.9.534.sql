...
SET VERSAOSISTEMA.SCRIPTADJUTOR = '3.0.9.534',
       VERSAOSISTEMA.DATA   = '01.07.2019',
	    VERSAO = '3.0.9.534'
...
comment ON COLUMN PRMT0001.PMT_CALCULARPV IS 'CALCULA PRECO DE VENDA: 0 = CUSTO LIQUIDO, 1 = CUSTO ENTRADA, 2 = CUSTO MEDIO';
