...
CREATE INDEX PRD0000_ENDERECAMENTO_IDX1
ON PRD0000_ENDERECAMENTO (PRDE_ENDERECO);

--------------------------------------------------------------------------------
commit work;

--vai dar erro na silentec pode ir para frente

CREATE INDEX PRD0000_CODIGO_IDX2
ON PRD0000_CODIGO (FOR_CODIGO);

CREATE INDEX PRD0000_CODIGO_IDX3
ON PRD0000_CODIGO (PRDC_REFERENCIA);

CREATE UNIQUE INDEX PRD_CODIGOORIGINAL_IDX1
ON PRD_CODIGOORIGINAL (PRDCO_REGISTRO);

CREATE INDEX PRD_CODIGOORIGINAL_IDX2
ON PRD_CODIGOORIGINAL (PRD_CODIGO);

CREATE INDEX PRD_CODIGOORIGINAL_IDX3
ON PRD_CODIGOORIGINAL (PRDCO_CODIGO_ORIGINAL);

--------------------------------------------------------------------------------
commit work;

Update VERSAOSISTEMA SET
       VERSAOSISTEMA.SCRIPTADJUTOR = '3.0.0.435' ,
       VERSAOSISTEMA.DATA   = '19.09.2015'
