ALTER TABLE PED_IT01_DI
    ADD PID_VIA_TRANSPORTE INTEGER,
    ADD PID_VALOR_AFRMM DECIMAL5,
    ADD PID_FORMA_IMPORTACAO INTEGER,
    ADD PID_CNPJ_ADQUIRENTE VARCHAR(14),
    ADD PID_UF_ADQUIRENTE VARCHAR(2);
--------------------------------------------------------------------------------
commit work;

ALTER TABLE NF0001
    ADD NF_CHAVE_NFE_REFERENCIADA VARCHAR(44);
...
Update VERSAOSISTEMA SET
       VERSAOSISTEMA.SCRIPTADJUTOR = '3.0.0.410' ,
       VERSAOSISTEMA.DATA   = '04.10.2014'
