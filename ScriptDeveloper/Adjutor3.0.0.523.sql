...
SET    VERSAOSISTEMA.SCRIPTADJUTOR = '3.0.9.523',
       VERSAOSISTEMA.DATA   = '15.10.2018',
       VERSAO = '3.0.9.523'
where VERSAOSISTEMA.CODIGO = 1;

ALTER TABLE KARDEX ADD CLI_CODIGO varchar(5);
ALTER TABLE kardex ADD FOR_CODIGO varchar(4);
ALTER TABLE KARDEX ADD COL_CODIGO INTEGER;

ALTER TABLE PRMT0001 ADD PMT_MEM_PESQPED VARCHAR(1);
COMMENT ON COLUMN PRMT0001.PMT_MEM_PESQPED IS 'MEMORIZAR ULTIMA CONSULTA DE ITEM ADICIONADO';

UPDATE PRMT0001 SET PMT_MEM_PESQPED = 'N';
