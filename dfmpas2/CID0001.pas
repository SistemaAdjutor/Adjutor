...
procedure TFormCadCidade.BuscaCidade;
begin
...
procedure TFormCadCidade.FormResize(Sender: TObject);
begin
     Width := 468;
     Height := 206;
end;

procedure TFormCadCidade.Bit_ListaClick(Sender: tObject);
begin
    try
      try
...
procedure TFormCadCidade.FormClose(Sender: tObject;
...
procedure TFormCadCidade.FormCloseQuery(Sender: tObject;
...
procedure TFormCadCidade.FormDestroy(Sender: TObject);
begin
     FormCadCidade := Nil;
end;

procedure TFormCadCidade.VerificaEdicao;
begin
...
procedure TFormCadCidade.DesabilitaBotoes;
begin
    BotoesAcesso;
...
procedure TFormCadCidade.HabilitaBotoes;
begin
...
procedure TFormCadCidade.MudaCorCampos(Sender: tObject);
begin
...
procedure TFormCadCidade.Bit_novoClick(Sender: tObject);
begin
...
procedure TFormCadCidade.Bit_ExcluirClick(Sender: tObject);
   var
      iRegistros:Integer;
begin
...
procedure TFormCadCidade.Bit_GravarClick(Sender: tObject);
begin
...
procedure TFormCadCidade.Bit_SairClick(Sender: tObject);
begin
   Close;
end;

procedure TFormCadCidade.BotoesAcesso;
begin
...
procedure TFormCadCidade.Bit_CancelarClick(Sender: tObject);
begin
    screen.Cursor := crHourglass;
    DataCadastros1.CdsCidade.Cancel;
...
procedure TFormCadCidade.EdtCidade_CodigoKeyPress(Sender: tObject;
  var Key: Char);
begin
...
procedure TFormCadCidade.EdtCidade_CodigoExit(Sender: tObject);
begin
...
procedure TFormCadCidade.EdtCidade_CodigoEnter(Sender: tObject);
begin
    EdtCidade_Codigo.SelectAll;
end;

procedure TFormCadCidade.DbeCid_CodIBGEKeyPress(Sender: tObject;
  var Key: Char);
begin
    if not (key in ['0'..'9',#8]) then
       begin
...
procedure TFormCadCidade.DBECid_CEP_InicialKeyPress(Sender: tObject;
  var Key: Char);
begin
    if not (key in ['0'..'9',#8]) then
       begin
...
procedure TFormCadCidade.DBECid_CEP_FinalKeyPress(Sender: tObject;
  var Key: Char);
begin
    if not (key in ['0'..'9',#8]) then
       begin
