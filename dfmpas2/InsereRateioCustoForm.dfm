inherited frmInsereRateioCusto: TfrmInsereRateioCusto
  Caption = 'frmInsereRateioCusto'
  ClientHeight = 192
  ClientWidth = 800
  ExplicitWidth = 816
  ExplicitHeight = 230
  ...
  object DBEdit1: TDBEdit [4]
    ...
    Width = 90
    Height = 21
    DataField = 'PCXP_INDICE'
    DataSource = dsEditS
    TabOrder = 4
  end
  object edConta: TSgDbSearchCombo [5]
    Left = 86
    Top = 28
    Width = 305
    Height = 21
  ...
  object edPerfil: TSgDbSearchCombo [6]
    Left = 86
    Top = 52
    Width = 305
    Height = 21
  ...
  object edCusto: TSgDbSearchCombo [7]
    Left = 86
    Top = 77
    Width = 305
    Height = 21
    ...
    TabOrder = 2
    CharCase = ecUpperCase
    LookupSelect = 'pcx_codigo, pcx_nivel, pcx_descri'
    ...
    AutoF8ColumnsTitulo = 'C'#243'digo, Nivel, Descri'#231#227'o'
    GridLeft = 0
    GridWidth = 0
    GridHeight = 100
    GridShowWhenEnter = False
  ...
  inherited qEdit: TSQLQuery
    SQL.Strings = (
      ...
      '                 PCXP_INDICE_REAL'
      '          from PCX0000_plano'
      '          where pcxp_registro=:ID')
    object qEditPCXP_REGISTRO: TIntegerField
    ...
    object qEditPCXP_TIPO: TStringField
      FieldName = 'PCXP_TIPO'
      ProviderFlags = [pfInUpdate]
      Size = 1
    end
    object qEditPCXP_INDICE: TFMTBCDField
      FieldName = 'PCXP_INDICE'
      ProviderFlags = [pfInUpdate]
      Precision = 18
      Size = 5
    end
    object qEditPCXP_INDICE_REAL: TFMTBCDField
  ...
  inherited DspEdit: TDataSetProvider
    AfterApplyUpdates = DspEditAfterApplyUpdates
  end
  inherited CdsEdit: TClientDataSet
    AfterInsert = CdsEditAfterInsert
    object CdsEditPCXP_REGISTRO: TIntegerField
      FieldName = 'PCXP_REGISTRO'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    ...
    object CdsEditPCXP_TIPO: TStringField
      FieldName = 'PCXP_TIPO'
      ProviderFlags = [pfInUpdate]
      Size = 1
    end
    object CdsEditPCXP_INDICE: TFMTBCDField
      FieldName = 'PCXP_INDICE'
      ProviderFlags = [pfInUpdate]
    ...
    object CdsEditPCXP_INDICE_REAL: TFMTBCDField
      FieldName = 'PCXP_INDICE_REAL'
      ProviderFlags = [pfInUpdate]
      Precision = 18
      Size = 5
