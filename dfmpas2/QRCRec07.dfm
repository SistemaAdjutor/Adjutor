object RelLiqFatu: TRelLiqFatu
  ...
  object QRGroup2: TQRGroup
    ...
    Size.Values = (
      52.916666666666670000
      1957.916666666667000000)
    Expression = 'TQReceber.FPC_VENCTO'
    FooterBand = GrFooter2
    Master = Owner
    ReprintOnNewPage = False
  end
  object GrFooter2: TQRBand
    Left = 38
    Top = 194
    Width = 740
    Height = 20
  ...
  object TQReceber: TQuery
    ...
    SQL.Strings = (
        ...
        'EMIS, Fat_pc01.FPC_NUMER, Fat_pc01.CCT_CODIGO, Fat_pc01.PCX_CODI' +
        'GO, Fat_pc01.BAN_CODIGO, Fat_pc01.FPC_COBNUM, Fat_pc01.FPC_COBTI' +
        'PO, Fat_pc01.FPC_STATUS, Fat_pc01.FPC_DESCTO, Fat_pc01.FPC_DTDES' +
        'C, Fat_pc01.FPC_VENCTO, Fat_pc01.FPC_PAGTO, Fat_pc01.FPC_VLPARC,' +
        ' Fat_pc01.FPC_VLPAGO, Fat_pc01.FPC_OBS, Fat_pc01.FPC_SITPAG, Fat' +
        '_pc01.EMP_CODIGO, Fat_pc01.CLI_CODIGO, Fat_pc01.FPC_IMPDUP, Cli0' +
        '000.CLI_CODIGO, Cli0000.CLI_RAZAO'
      'FROM FAT_PC01 Fat_pc01'
      '   LEFT OUTER JOIN CLI0000 Cli0000'
      '   ON  (Fat_pc01.CLI_CODIGO = Cli0000.CLI_CODIGO)  '
      'ORDER BY Fat_pc01.FPC_VENCTO')
    Left = 380
    Top = 3
