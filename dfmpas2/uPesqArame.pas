...
begin
  ...
  try
     ...
     1: flg:=tcr.novo('Novo Registro') ;
		 ...
		 3: flg:=tcr.edita(cdsBusco.FieldByName('ARA_CODIGO').asString,'Edição de Registro');
     4: flg:=tcr.exclui(cdsBusco.FieldByName('ARA_CODIGO').asString,'Exclusão de Registro');
     end;
