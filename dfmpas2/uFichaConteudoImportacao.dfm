inherited frmFichaConteudoImportacao: TfrmFichaConteudoImportacao
  ...
  inherited cdsBusca: TFDQuery
    ...
    object cdsBuscaPRD_FCI_DATA_GERACAO: TSQLTimeStampField
      FieldName = 'PRD_FCI_DATA_GERACAO'
    end
  end
  ...
  inherited PopupMenu2: TPopupMenu
    ...
    object ListadeItens1: TMenuItem
      ...
      OnClick = ListadeItens1Click
    end
    object PercentuaisdaFCI1: TMenuItem
      Caption = 'Percentuais da FCI'
      OnClick = PercentuaisdaFCI1Click
    end
  end
  ...
  object frxDBListaItens: TfrxDBDataset
    UserName = 'frxDBListaItens'
    CloseDataSource = False
    FieldAliases.Strings = (
      'PRD_REFER=PRD_REFER'
      'PRD_DESCRI=PRD_DESCRI'
      ...
      'PRD_ORIGEM=PRD_ORIGEM'
      'CI=CI'
      'FTC_BASEFORMULA=FTC_BASEFORMULA'
      'PRD_FCI_DATA_GERACAO=PRD_FCI_DATA_GERACAO')
    DataSet = cdsBusca
    BCDToCurrency = False
    Left = 36
    Top = 297
  end
  object frxListaItens: TfrxReport
    Version = '6.9.3'
    DotMatrixReport = False
    IniFile = '\Software\Fast Reports'
    PreviewOptions.Buttons = [pbPrint, pbLoad, pbSave, pbExport, pbZoom, pbFind, pbOutline, pbPageSetup, pbTools, pbEdit, pbNavigator, pbExportQuick]
    ...
    ScriptText.Strings = (
      ...
      ''
      'end.')
    OnBeginDoc = frxListaItensBeginDoc
    OnGetValue = frxListaItensGetValue
    Left = 33
    Top = 345
    Datasets = <
      item
        DataSet = frxDBListaItens
        DataSetName = 'frxDBListaItens'
      end>
    Variables = <>
    Style = <>
    object Data: TfrxDataPage
    ...
    object Page1: TfrxReportPage
      ...
      object MasterData1: TfrxMasterData
        ...
        DataSetName = 'frxDBListaItens'
        RowCount = 0
        object frxDBListaItensPRD_REFER: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            '[frxDBListaItens."PRD_REFER"]')
        end
        object frxDBListaItensPRD_DESCRI: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            '[frxDBListaItens."PRD_DESCRI"]')
        end
        object frxDBListaItensPTI_SIGLA: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
          Left = 540.472790000000000000
          Top = 1.000000000000000000
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            '[frxDBListaItens."PTI_SIGLA"]')
        end
        object frxDBListaItensNCM: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
        ...
        object frxDBListaItensPRD_UND: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            '[frxDBListaItens."PRD_UND"]')
        end
        object frxDBListaItensPRD_ORIGEM: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
        ...
        object frxDBListaItensPRD_FCI_VALOR_PARCELA_IMPORTADA: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[frxDBListaItens."PRD_FCI_VALOR_PARCELA_IMPORTADA"]')
          ParentFont = False
        end
        object frxDBListaItensVALOR_TOTAL: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[frxDBListaItens."VALOR_TOTAL"]')
          ParentFont = False
        end
        object frxDBListaItensCI: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
  ...
  object frxPercentuaisFCI: TfrxReport
    Version = '6.9.3'
    DotMatrixReport = False
    IniFile = '\Software\Fast Reports'
    PreviewOptions.Buttons = [pbPrint, pbLoad, pbSave, pbExport, pbZoom, pbFind, pbOutline, pbPageSetup, pbTools, pbEdit, pbNavigator, pbExportQuick]
    ...
    object Page1: TfrxReportPage
      ...
      object MasterData1: TfrxMasterData
        ...
        object frxDBListaItensPRD_FCI_VALOR_PARCELA_IMPORTADA: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[frxDBListaItens."PRD_FCI_DATA_GERACAO"]')
          ParentFont = False
        end
        object frxDBListaItensVALOR_TOTAL: TfrxMemoView
          IndexTag = 1
      ...
      object PageHeader1: TfrxPageHeader
        ...
        object Memo13: TfrxMemoView
          AllowVectorExport = True
          Left = 538.149970000000000000
          Top = 70.606370000000000000
          Width = 105.826695980000000000
