object FormFTCMaterial: TFormFTCMaterial
  Left = 192
  Top = 23
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Item da Ficha T'#233'cnica'
  ClientHeight = 509
  ClientWidth = 528
  Color = clBtnFace
  ...
  object DbGridMat: TDBGrid
    ...
    TitleFont.Style = []
    OnDblClick = DbGridMatDblClick
    OnKeyPress = DbGridMatKeyPress
    Columns = <
      item
        Expanded = False
        FieldName = 'PRD_REFER'
