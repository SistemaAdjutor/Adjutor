...
var
  ...
  wForaEstSN, opeNatureza, iRegCfopPrincipal, wCST_CODIGO, wTemSubs, wExterior, cliIE : string;
...
begin
  ...
  cliIE := BuscaUmDadoSQLAsString('SELECT CLI_INSC FROM CLI0000 c WHERE CLI_CODIGO = ' + QuotedStr(SqlCdsPedidoCLI_CODIGO.AsString));
