object FrmConsultarCNPJ: TFrmConsultarCNPJ
  ...
  object Panel1: TPanel
    ...
    object Label1: TLabel
      ...
      Height = 26
      Caption = 
        'Se acontecer SocketError fa'#231'a v'#225'rias tentativas at'#233' atualizar o ' +
        'Captha e/ou veja se internet est'#225' conectada. As informa'#231#245'es veem' +
        ' da Receita Federal que pode estar indispon'#237'vel'
      WordWrap = True
    end
  ...
  object ACBrConsultaCNPJ_cliente: TACBrConsultaCNPJ
    ProxyPort = '8080'
    PesquisarIBGE = False
    Left = 444
    Top = 47
