inherited frmSecuritizadora: TfrmSecuritizadora
  ...
  inherited qEdit: TSQLQuery
    SQL.Strings = (
      'SELECT * FROM SECURITIZADORA WHERE SEC_CODIGO = :ID')
    object qEditSEC_CODIGO: TIntegerField
      DisplayWidth = 3
      FieldName = 'SEC_CODIGO'
      Required = True
    end
    object qEditSEC_DESCRICAO: TStringField
  ...
  inherited CdsEdit: TClientDataSet
    object CdsEditSEC_CODIGO: TIntegerField
      DisplayWidth = 3
      FieldName = 'SEC_CODIGO'
      Required = True
    end
    object CdsEditSEC_DESCRICAO: TStringField
      FieldName = 'SEC_DESCRICAO'
      Size = 255
    end
