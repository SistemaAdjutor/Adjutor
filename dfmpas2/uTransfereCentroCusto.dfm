inherited frmTransfereCentroCusto: TfrmTransfereCentroCusto
  Caption = 'Transfer'#234'ncia de Centro de Custos'
  ClientHeight = 442
  ClientWidth = 575
  ...
  object ENF_IT01_PROJETO_OBRA: TCheckBox [8]
    ...
    Height = 17
    Caption = 
      'Vincula'#231#227'o de Centro de Custo na Nota Fiscal de Entrada (ENF_IT0' +
      '1_PROJETO_OBRA)'
    TabOrder = 8
  end
  ...
  object PCX0000_PERFIL_COLABORADOR: TCheckBox [20]
    ...
    Height = 17
    Caption = 
      'Rateio de Colaboradores por Centro de Custo (PCX0000_PERFIL_COLA' +
      'BORADOR)'
    TabOrder = 20
  end
  ...
  object qCentroCustoOrigen: TSQLQuery
    MaxBlobSize = -1
    Params = <>
    SQL.Strings = (
  ...
  object qCentroCustoDestino: TSQLQuery
    MaxBlobSize = -1
    Params = <>
    SQL.Strings = (
      'select PCX_DESCRI,PCX_CODIGO'
