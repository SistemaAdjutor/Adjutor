inherited FormCliente: TFormCliente
  ...
  object SqlCdsTransp: TSqlClientDataSet [11]
    Aggregates = <>
  ...
  object SqlCdsRegiao: TSqlClientDataSet [12]
    Aggregates = <>
  ...
  object SqlCdsDupFat: TSqlClientDataSet [13]
    Aggregates = <>
    DataSet.CommandText = 
  ...
  object DsDupFat: TDataSource [14]
    DataSet = SqlCdsDupFat
    OnDataChange = DsDupFatDataChange
    Left = 672
    Top = 276
  end
  object SqlCdsNFS: TSqlClientDataSet [15]
    Aggregates = <>
    DataSet.CommandText = 
  ...
  object DsNFS: TDataSource [16]
    DataSet = SqlCdsNFS
    Left = 760
    Top = 140
  end
  object SqlCdsProdNF: TSqlClientDataSet [17]
    Aggregates = <>
    DataSet.CommandText = 
  ...
  object DsProdNF: TDataSource [18]
    DataSet = SqlCdsProdNF
    Left = 1184
    Top = 404
  end
  object SqlCdsBanco: TSqlClientDataSet [19]
    Aggregates = <>
  ...
  object SqlCdsPrazo: TSqlClientDataSet [20]
    Aggregates = <>
  ...
  object DSPais: TDataSource [21]
    DataSet = SqlCdsPais
    Left = 1238
    Top = 216
  end
  object SqlCdsPais: TSqlClientDataSet [22]
    Aggregates = <>
  ...
  object CdsCFOP: TSqlClientDataSet [23]
    Aggregates = <>
  ...
  object DsCfop: TDataSource [24]
    DataSet = CdsCFOP
    Left = 1262
    Top = 505
  end
  object dsVendas: TDataSource [25]
    DataSet = CdsVendas
    Left = 1566
    Top = 328
  end
  object CdsVendas: TSqlClientDataSet [26]
    Aggregates = <>
    DataSet.CommandText = 
  ...
  object DsClienteContato: TDataSource [28]
    DataSet = CdsClienteContato
    Left = 1176
    Top = 162
  end
  object CdsClienteContato: TClientDataSet [29]
    Aggregates = <>
    PacketRecords = 10
    Params = <>
  ...
  object DspClienteContato: TDataSetProvider [30]
  ...
  object SqlCLienteContato: TSQLDataSet [31]
    GetMetadata = False
  ...
  object frxVendas: TfrxReport [32]
    Version = '6.9.3'
  ...
  object frxdbCliente: TfrxDBDataset [33]
  ...
  object frxdbVendas: TfrxDBDataset [34]
  ...
  object SqlCdsGraficoVendas: TSqlClientDataSet [35]
    Aggregates = <>
    DataSet.CommandText = 
  ...
  object SqlAvisos: TSQLDataSet [36]
    GetMetadata = False
  ...
  object DspAvisos: TDataSetProvider [37]
    DataSet = SqlAvisos
    Options = [poAllowCommandText]
    UpdateMode = upWhereKeyOnly
    Left = 1387
  ...
  object CdsAvisos: TClientDataSet [38]
    Aggregates = <>
    PacketRecords = 10
    Params = <>
  ...
  object dsAvisos: TDataSource [39]
    DataSet = CdsAvisos
    Left = 1555
    Top = 115
  end
  object SqlCdsCNAE: TSqlClientDataSet [40]
    Aggregates = <>
    DataSet.CommandText = 
  ...
  object SqlArquivo: TSQLDataSet [45]
  ...
  object DspArquivo: TDataSetProvider [46]
    DataSet = SqlArquivo
    Options = [poAllowCommandText]
    UpdateMode = upWhereKeyOnly
    Left = 963
  ...
  object CdsArquivo: TClientDataSet [47]
    Aggregates = <>
    PacketRecords = 10
    Params = <>
  ...
  object dsArquivo: TDataSource [48]
    DataSet = CdsArquivo
    Left = 780
    Top = 293
  end
  object pmArquivo: TPopupMenu [49]
    Left = 1276
    Top = 8
  ...
  object qItensTabela: TSQLQuery [51]
    MaxBlobSize = -1
    Params = <>
    SQL.Strings = (
  ...
  object DspItensTabela: TDataSetProvider [52]
    DataSet = qItensTabela
    Left = 1488
    Top = 447
  end
  object cdsItensTabela: TClientDataSet [53]
    Aggregates = <>
    FieldDefs = <>
    IndexDefs = <>
    PacketRecords = 200
  ...
  object dsItensTabela: TDataSource [54]
    DataSet = cdsItensTabela
    Left = 1565
    Top = 447
  end
  object sqlClienteEnder: TSQLQuery [55]
    MaxBlobSize = -1
    Params = <
      item
        DataType = ftString
  ...
  object dspClienteEnder: TDataSetProvider [56]
  ...
  object cdsClienteEnder: TClientDataSet [57]
    Aggregates = <>
    PacketRecords = 5
    Params = <
      item
  ...
  object dsClienteEnder: TDataSource [58]
    AutoEdit = False
    DataSet = cdsClienteEnder
    Left = 1293
    Top = 445
  end
  object cdsEnderPadrao: TClientDataSet [59]
    Aggregates = <>
    PacketRecords = 5
    Params = <
      item
  ...
  object sqlEnderPadrao: TSQLQuery [60]
    MaxBlobSize = -1
    Params = <
      item
        DataType = ftInteger
  ...
  object dspEnderPadrao: TDataSetProvider [61]
  ...
  object DataSetProvider1: TDataSetProvider [62]
    DataSet = sqlEnderPadrao
    Options = [poAllowCommandText, poUseQuoteChar]
    UpdateMode = upWhereKeyOnly
    Left = 1349
  ...
  object DataSetProvider2: TDataSetProvider [63]
    DataSet = sqlEnderPadrao
    Options = [poAllowCommandText, poUseQuoteChar]
    UpdateMode = upWhereKeyOnly
    Left = 1485
  ...
  object JvPopupMenu1: TJvPopupMenu [66]
    ImageMargin.Left = 0
    ImageMargin.Top = 0
    ImageMargin.Right = 0
  ...
  object qArquivoBlob: TSQLDataSet [68]
    CommandText = 'SELECT * FROM ARQUIVO ORDER BY ARQ_DESCRICAO'
    MaxBlobSize = 1
    Params = <>
    SQLConnection = DataCadastros.SQLConnection1
  ...
  object dsExportaExcel: TDataSource [75]
    DataSet = cdsClientes
    Left = 456
    Top = 524
  end
  object qClientes: TSQLQuery [76]
    MaxBlobSize = -1
    Params = <>
    SQL.Strings = (
      ' SELECT'
  ...
  object cdsClientes: TClientDataSet [78]
    Aggregates = <>
    Params = <>
  ...
  object SimpleDataSet1: TSimpleDataSet [80]
    Aggregates = <>
    DataSet.MaxBlobSize = -1
    DataSet.Params = <>
    Params = <>
