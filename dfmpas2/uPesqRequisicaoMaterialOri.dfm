inherited frmPesqRequisicaoMaterialOri: TfrmPesqRequisicaoMaterialOri
  Caption = 'Origem da Requisi'#231#227'o de Materiais'
  ExplicitWidth = 683
  ExplicitHeight = 482
  PixelsPerInch = 96
  TextHeight = 13
  ...
  inherited qBusco: TSQLQuery
    SQL.Strings = (
      'SELECT * FROM REQUISICAO_MATERIAL_ORI')
  end
  inherited cdsBusco: TClientDataSet
    object cdsBuscoRMO_CODIGO: TIntegerField
      FieldName = 'RMO_CODIGO'
      Required = True
    end
    object cdsBuscoRMO_DESCRICAO: TStringField
      FieldName = 'RMO_DESCRICAO'
      Size = 255
    end
  end
