...
resourcestring
  ...
  SDuplicateReference = 'WritesqlUpdate.sql.text called twice for the same instance';
  ...
  SMsgDlgHelp = '&Ajuda';
  SMsgDlgHelpNone = 'Ajuda não disponivel';
  SMsgDlgHelpHelp = 'Ajuda';
  SMsgDlgAbort = '&Abortar';
  SMsgDlgRetry = '&Tentar';
  SMsgDlgIgnore = '&Ignore';
  SMsgDlgAll = '&Tudo';
  SMsgDlgNoToAll = 'Não´para Tudo';
  SMsgDlgYesToAll = 'Sim para Tudo';
  ...
  SDateEncodeError = 'Argumento inválido para codificação da data.';
