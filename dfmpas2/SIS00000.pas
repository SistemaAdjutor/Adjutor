...
TMinhaThread = class(TThread)
   private
      ...
      constructor Create(CreateSuspended: Boolean; AForm: TFrmMenu);
end;
...
uses DataCad, Prmd0001, SISP0001, val0002, val0001, uteis, iniciodb;
...
begin
  ...
  begin
      ...
      try
        ...
        if ((IBDatabaseInfo1.UserNames.Count-2) > Conexoes(dbInicio.Empresa.CHAVE)) and (not bChavaValidador) then
        begin
...
constructor TMinhaThread.Create(CreateSuspended: Boolean; AForm: TFrmMenu);
begin
...
try
  //Variaveis
    retorno := '';
    vXMLDoc := _Form.vXMLDoc;
    IdHTTP1 := _Form.IdHTTP1;
    //Monta XML
