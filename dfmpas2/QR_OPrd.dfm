object RelOrdemProd: TRelOrdemProd
  Left = -8
  Top = 0
  Width = 816
  Height = 1056
  ...
  object QRBand1: TQRBand
    ...
    object QRLabel1: TQRLabel
      ...
      AutoSize = True
      AutoStretch = False
      Caption = 'FOLHA DE PESAGEM (PRODUÇÃO)'
      Color = clWhite
      Transparent = False
      WordWrap = True
      FontSize = 10
  ...
  object QRBand2: TQRBand
    ...
    object QRExpr2: TQRExpr
      ...
      Expression = 
        ...
        'QTDE4 > 0,TQOrdemItem.OSI_QTDE4 * TQOrdemItem.OSI_UC / 1000,TQOr' +
        'demItem.OSI_QTDE5 * TQOrdemItem.OSI_UC / 1000))))'
      Mask = '#0.,000'
      FontSize = 8
    end
  end
  object QRBand3: TQRBand
    ...
    object QRLabel29: TQRLabel
      ...
      AutoSize = True
      AutoStretch = False
      Caption = 'RETORNO DO LABORATÓRIO :'
      Color = clWhite
      Font.Charset = ANSI_CHARSET
      Font.Color = clWindowText
      Font.Height = -11
  ...
  object TQOrdemServ: TQuery
    ...
    SQL.Strings = (
        ...
        '01.OSV_DCMOD4, OSV0001.OSV_DCMOD5, OSV0001.OSV_DCMOD6'
    ...
    object TQOrdemServOSV_QTDE: TSmallintField
      FieldName = 'OSV_QTDE'
