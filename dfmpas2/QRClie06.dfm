object RelCliente06: TRelCliente06
  Left = 0
  Top = 0
  Width = 816
  Height = 1056
  ...
  object QRBand1: TQRBand
    ...
    object LTitulo1: TQRLabel
      ...
      AutoSize = True
      AutoStretch = False
      Caption = 'PRODUTOS VENDIDOS PARA O CLIENTE'
      Color = clWhite
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -13
  ...
  object TQFatItens: TQuery
    ...
    SQL.Strings = (
        ...
        't0000.FAT_CODIGO, Fat0000.CLI_CODIGO, Fat0000.FAT_DTEMIS, Fat000' +
        '0.FAT_CANCELADA'
      'FROM FAT_IT02 Fat_it02, PRD0000 Prd0000, FAT0000 Fat0000'
      'WHERE  (Fat_it02.PRD_REFER = Prd0000.PRD_REFER)  '
      '   AND  (Fat_it02.FAT_CODIGO = Fat0000.FAT_CODIGO)  ')
    Left = 80
    Top = 8
    object TQFatItensFat_it02FAT_CODIGO: TStringField
      FieldName = 'Fat_it02.FAT_CODIGO'
      Origin = 'FAT_IT02.FAT_CODIGO'
      Size = 6
    end
    object TQFatItensPRD_CODIGO: TStringField
      FieldName = 'PRD_CODIGO'
      Origin = 'FAT_IT02.PRD_CODIGO'
      Size = 4
    end
    object TQFatItensFat_it02PRD_REFER: TStringField
      FieldName = 'Fat_it02.PRD_REFER'
      Origin = 'FAT_IT02.PRD_REFER'
      Size = 11
    end
    object TQFatItensFIT_QTDE: TFloatField
      FieldName = 'FIT_QTDE'
      Origin = 'FAT_IT02.FIT_QTDE'
    end
    object TQFatItensFIT_IPIALIQ: TFloatField
      FieldName = 'FIT_IPIALIQ'
      Origin = 'FAT_IT02.FIT_IPIALIQ'
    end
    object TQFatItensFIT_PRECO: TFloatField
      FieldName = 'FIT_PRECO'
      Origin = 'FAT_IT02.FIT_PRECO'
    end
    object TQFatItensEMP_CODIGO: TStringField
      FieldName = 'EMP_CODIGO'
      Origin = 'FAT_IT02.EMP_CODIGO'
      Size = 3
    end
    object TQFatItensPRD_DESCRI: TStringField
      FieldName = 'PRD_DESCRI'
      Origin = 'PRD0000.PRD_DESCRI'
      Size = 40
    end
    object TQFatItensPrd0000PRD_REFER: TStringField
      FieldName = 'Prd0000.PRD_REFER'
      Origin = 'PRD0000.PRD_REFER'
      Size = 11
    end
    object TQFatItensFat0000FAT_CODIGO: TStringField
      FieldName = 'Fat0000.FAT_CODIGO'
      Origin = 'FAT0000.FAT_CODIGO'
      Size = 6
    end
    object TQFatItensCLI_CODIGO: TStringField
      FieldName = 'CLI_CODIGO'
      Origin = 'FAT0000.CLI_CODIGO'
      Size = 5
    end
    object TQFatItensFAT_DTEMIS: TDateTimeField
      FieldName = 'FAT_DTEMIS'
      Origin = 'FAT0000.FAT_DTEMIS'
    end
    object TQFatItensFAT_CANCELADA: TBooleanField
