...
Procedure Register;
begin
 RegisterComponents('Novi', [TSgDbSearchComboFDACcx]);
end;
...
procedure TSgDbSearchComboFDACcx.SetAutoF8(const Value: TDBAutoF8);
begin
 vlAutoF8 := Value;
end;
...
function TSgDbSearchComboFDACcx.GetAutoF8: TDBAutoF8;
begin
 result := vlAutoF8;
end;
