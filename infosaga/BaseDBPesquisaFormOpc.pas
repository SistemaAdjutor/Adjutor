...
procedure TfrmBaseDBPesquisaOpc.DefaultOnChange(Sender: TObject); // onchange reset timer (atribuição automática para tEdit)
...
procedure TfrmBaseDBPesquisaOpc.ResetTimer; // onclick reset timer (atribuição manual)
begin
